...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Search Volume Modeling script for managing export to mozilla-central")
    ...
    parser.add_argument("--mozilla-central-subdir",
                        default="browser/extensions/searchvolmodel/",
    ...
    parser.add_argument("--run-tests",
                        action="store_true",
                        help="Whether or not to run Search Volume Modeling tests after the build.")
